      ...
      {tab === 'developer' && (
        <div>
          ...
          <Section title="Build on CronStream" desc="Want to embed milestone-gated streaming into your own product? Apply for platform access.">
            ...
            <a
              href="https://mail.google.com/mail/?view=cm&to=thecronstream@gmail.com&su=Platform+API+Application&body=Product+description%3A%0A%0AExpected+monthly+stream+volume%3A%0A%0AWebsite+%2F+GitHub%3A%0A%0AContact+email%3A"
              target="_blank"
